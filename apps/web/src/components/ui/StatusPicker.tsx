...
import {
  MinusCircleIcon, CalendarDaysIcon, UserIcon, CheckCircleIcon,
...
// Every FollowUpStatus a card can carry MUST appear here — otherwise the
// Dropdown silently falls back to the first option ("Хэвийн") and the card
// misreports its real status.
export const STATUS_OPTIONS: DropdownOption<FollowUpStatus>[] = [
  ...
  { value: 'contacted',         label: 'Цаг товлосон',        Icon: CalendarDaysIcon,         iconClass: 'text-fu-contacted' },
