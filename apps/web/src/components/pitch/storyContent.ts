...
export const STEPS: FlowStep[] = [
  ...
  { num: '03', title: 'Урьдчилсан дүгнэлт', sub: 'Зургийг танин дүгнэлт өгөх', fx: 0.86, fy: 0.28 },
  ...
  { num: '06', title: 'Бүртгэлтэй шүдний эмчтэй холбох', sub: 'Яаралтай эмчилгээ шаардлагатай тохиолдолд', fx: 0.15, fy: 0.72 },
]
