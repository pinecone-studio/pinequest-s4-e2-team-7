...
const CohortCard = ({ school }: { school: School }) => {
  ...
  return (
    <Card interactive className="group flex items-center gap-3">
      <div className="flex size-10 shrink-0 items-center justify-center rounded-2xl bg-primary-subtle text-[12px] font-bold text-primary transition-transform duration-200 group-hover:scale-110">
