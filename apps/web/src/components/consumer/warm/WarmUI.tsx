...
export const FeatureRow = ({
  ...
  <li className={cn('flex items-center gap-3 py-3.5 text-[14px] text-text-muted', className)}>
    <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-[#0e9594]/10 text-[#0b7a79] dark:text-primary">
      {icon}
    </span>
    {label}
  </li>
...
export const PillButton = ({
  ...
  const variants = {
    primary:
      'bg-primary text-text-on-primary font-semibold shadow-[0_2px_8px_rgba(14, 149, 148,0.25)] hover:bg-primary-hover active:scale-[0.98]',
    secondary:
...
export const FilterPill = ({
  ...
  <button
    ...
    className={cn(
      ...
      active
        ? 'bg-primary text-text-on-primary shadow-[0_2px_8px_rgba(14, 149, 148,0.25)]'
