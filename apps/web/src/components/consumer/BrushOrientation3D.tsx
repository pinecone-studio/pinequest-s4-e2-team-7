    ...
    <div className="warm-card overflow-hidden p-0">
      ...
      <div className="grid gap-0 xl:grid-cols-[1fr_240px]">
        ...
        <div className="space-y-4 p-5">
          {zone ? (
            <div className="rounded-2xl bg-[#0e9594]/12 px-4 py-3 text-center">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-xl border border-[#E0E0E0] bg-white px-3 py-2 font-mono text-[11px] text-slate-900 placeholder:text-slate-400 outline-none focus:border-[#0e9594]"
              spellCheck={false}
            />
            <button
              type="button"
