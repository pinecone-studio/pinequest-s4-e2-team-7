...
export const printChildSummary = (
  ...
  <div class="no-print" style="margin-top:24px;text-align:center;">
    <button onclick="window.print()" style="background:#0e9594;border:none;border-radius:10px;padding:10px 28px;font-size:14px;font-weight:700;cursor:pointer;color:#ffffff;">PDF хадгалах / Хэвлэх</button>
  </div>
</body></html>`
