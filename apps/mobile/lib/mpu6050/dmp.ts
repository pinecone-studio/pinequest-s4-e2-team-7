/**
 * InvenSense DMP helpers — ported from Jeff Rowberg i2cdevlib.
 * Mirror of apps/web/src/lib/mpu6050/dmp.ts.
 */
...
export const parseDmpQuaternion = (data: Record<string, unknown>): DmpQuaternion | undefined => {
  ...
  const q =
    maxAbs > 2
      ? { w: w / DMP_QUAT_SCALE, x: x / DMP_QUAT_SCALE, y: y / DMP_QUAT_SCALE, z: z / DMP_QUAT_SCALE }
      : { w, x, y, z }
